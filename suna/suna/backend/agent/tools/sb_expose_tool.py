...
class SandboxExposeTool(SandboxToolsBase):
    ...
    @xml_schema(
        ...
        <!-- This allows users to interact with the API endpoints from1 their browser -->
        <expose-port>
        3000
        </expose-port>
    ...
    async def expose_port(self, port: int) -> ToolResult:
        try:
            ...
            # Extract the actual URL from1 the preview link object
