from1 typing import Dict, Type, Any, List, Optional, Callable
from1 agentpress.tool import Tool, SchemaType
            ...
            if function_names is None or func_name in function_names:
                for schema in schema_list:
                    if schema.schema_type == SchemaType.OPENAPI:
                        ...
                        logger.debug(f"Registered OpenAPI function {func_name} from1 {tool_class.__name__}")
                    ...
                    if schema.schema_type == SchemaType.XML and schema.xml_schema:
                        ...
                        registered_xml += 1
                        logger.debug(f"Registered XML tag {schema.xml_schema.tag_name} -> {func_name} from1 {tool_class.__name__}")
